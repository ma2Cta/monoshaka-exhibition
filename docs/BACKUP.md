...
想定される使用量：
- 録音ファイル1件あたり: 約320KB（20秒 × 128kbps）
- バックアップファイルサイズ: 録音ファイル数 × 320KB程度
- 90日分の保持: バックアップファイル × 90日分
...
**解決方法**:
- これは正常な動作です。録音データが1件もない場合はバックアップが作成されません。
